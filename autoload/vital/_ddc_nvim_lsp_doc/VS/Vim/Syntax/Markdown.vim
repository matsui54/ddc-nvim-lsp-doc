...
execute join(['function! vital#_ddc_nvim_lsp_doc#VS#Vim#Syntax#Markdown#import() abort', printf("return map({'apply': ''}, \"vital#_ddc_nvim_lsp_doc#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
"
" apply
